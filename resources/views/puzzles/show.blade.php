                    ...
                    <div class="col col-lg-9 col-md-8 ">
                        ...
                        <div class="panel panel-default" style="box-shadow: 3px 3px 3px 3px rgba(0,0,0,.05);">
                            ...
                            <div class="panel-body">
                               <a class="btn btn-lg btn-danger" style="margin-top: 4px;" href="/user/challenge"><b>Challenge Friends</b></a> &nbsp;
                               <a class="btn btn-lg btn-info" style="margin-top: 4px;" href="/puzzles/random"><b>New Puzzle</b></a> &nbsp;
                               <a class="btn btn-lg btn-success" style="margin-top: 4px;" href="/user/save?type=puzzle&id={{$puzzle->id}}"><b>Save Puzzle</b></a> &nbsp;
