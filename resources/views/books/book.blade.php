<div class="col col-md-4 col-xs-6">
    <div class="grid panel panel panel-default" style="padding: 10px 10px 10px 10px;box-shadow: 3px 3px 3px 3px rgba(0,0,0,.05);background: #f7f7f7;height: 620px;">  
     <div class="panel-heading" style="background: #2e6300"></div>
        ...
        ?>
        <div class="details">
            <h3 style="font-size: 18px;"><a href="{{ $book->link }}" target="_blank">{{ str_limit($value, $limit = 100, $end = '...') }}</a></h3>
