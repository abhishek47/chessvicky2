					...
					<!-- Begin Panel -->
							        ...
							        <tbody>
							         ...
							         <?php foreach ($puzzles as $key => $puzzle) : ?>
							            <tr>
							                ...
							                <td><?= $puzzle->moves; ?></td>
							                <td>
							                	<a href="/admin/puzzles/edit/{{$puzzle->id}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</a>
							                	<a href="/admin/puzzles/delete/{{$puzzle->id}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</a>
							                </td>
							            </tr>
							          <?php endforeach; ?>  
							        </tbody>
						...
						<div class="panel panel-plain panel-rounded">
							...
							<div class="panel-body p-t-xs">
								...
								<form action="/admin/puzzles/store" method="post">
