					...
					<div class="rs-dashhead m-b-lg">
						<div class="rs-dashhead-content">
							<div class="rs-dashhead-titles">
								<h3 class="rs-dashhead-title">Edit Tutorials</h3>
					...
					<div class="container-fluid">
						...
						<div class="panel panel-plain panel-rounded">
							<div class="panel-heading borderless">
								<h3 class="panel-title">Edit Tutorial</h3>
							...
							<div class="panel-body p-t-xs">
								...
								<form action="<?= url('tutorials/update/' . $tutorial->id); ?>" method="post">

									
								<div class="form-group">
										<label>Title</label>
										<input type="text" name="title" value="<?= $tutorial->title; ?>" class="form-control">
									</div>
								

									<div class="form-group">
										<textarea name="body" class="summernote-fixed-height" title="Contents"><?= $tutorial->body; ?></textarea>
									</div><!-- /.form-group -->


									<div class="form-group">
										<label>Author</label>
										<input type="text" class="form-control" name="author" value="<?= $tutorial->author; ?>" placeholder="Akash Wani">
									</div>

									<div class="form-group">
										<label>Tags</label>
										<input type="text" name="tags" class="rs-selectize-tags" value="<?= $tutorial->tags; ?>" placeholder="Input Tags">
									</div><!-- /.form-group -->
									
									<div class="form-group has-feedback">
										<label class="control-label">Publish Date</label>
										<input type="text" name="published_at" value="<?= $tutorial->published_at; ?>" class="form-control rs-datepicker" data-date-format="yyyy-mm-dd" placeholder="YYYY-MM-DD" readonly>
										<span class="fa fa-calendar form-control-feedback" aria-hidden="true"></span>
									</div><!-- /.form-group -->

									<div class="form-group">
										<input type="submit" class="btn btn-success" name="addtutorial" value="Update Tutorial" >
									</div>
