                                      ...
                                      <div class="col col-md-6">
                                       ...
                                       <div class="col col-md-6">
                                        <ul class="member-info">
                                            ...
                                            <li><i class="fa fa-user"></i> <b>Leaderboard Rank :</b> {{ getRankOfCurrentUser() }} &nbsp; <span style="font-size: 14px;"><a href="/leaderboard"><i class="fa fa-bars"></i>  View Leaderboard</a></span></li>
