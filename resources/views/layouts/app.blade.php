                          ...
                          <!--  <li><a href="/events">Events</a></li> -->
                            ...
                            @else
                                <li class="sub-menu">
                                    ...
                                    @else
                                     <span class="chatter_avatar_circle small" style="background-color:#<?= \DevDojo\Chatter\Helpers\ChatterHelper::stringToColorCode( Auth::user()->name) ?>;width: 30px;height: 30px; ">
